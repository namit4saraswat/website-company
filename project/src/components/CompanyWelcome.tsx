      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-600">
            At CodeAspire, we're passionate about transforming aspiring developers into industry professionals through comprehensive education and practical experience.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2">
            <div className="p-8 lg:p-12">
              ...
              <p className="text-gray-600 mb-6">
                Founded in 2020, CodeAspire emerged from a simple vision: making quality programming education accessible to everyone. What started as a small community has grown into a global platform, helping thousands of students achieve their dreams.
              </p>
